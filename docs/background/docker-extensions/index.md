...
You can seamlessly connect your favorite development tools to your application development and deployment workflows. Augment Docker Desktop with debugging, testing, security, and networking functionalities, and create custom add-ons using the Extensions [SDK](./extensions-sdk.md).
...
- [Marketplace extensions](./marketplace.md)

- [Non-marketplace extensions](./non-marketplace.md)

- [Configure a private marketplace for extensions](./private-marketplace.md)

- [Settings and feedback for Docker Extensions](./settings-feedback.md)

- [Overview of the Extensions SDK](./extensions-sdk.md)
