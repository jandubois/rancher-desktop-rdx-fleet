...
![Flow for OAuth 2.0](./extensions-sdk/guides/oauth2-flow/images/oauth.png)
...
Use the [ddClient.host.openExternal](./extensions-sdk/guides/dev/api/dashboard.md) API to open a browser to the auth URL. For
example:
...
> [!IMPORTANT]
>
> Using this feature requires the extension SDK 0.3.3 in Docker Desktop. You need to ensure that the required SDK version for your extension set with `com.docker.desktop.extension.api.version` in [image labels](./extensions-sdk/guides/extensions/labels.md) is higher than 0.3.3.
...
Learn how to [publish and distribute your extension](./extensions-sdk/guides/extensions.md)
