...
Learn more about extensions [architecture](./extensions-sdk/guides/architecture.md).
...
In your extension, use the Docker Desktop Client object to [invoke the shell script](./extensions-sdk/guides/dev/api/backend.md)
