...
![Navigate to extension link](./extensions-sdk/extensions/share/images/open-share.png)
...
- Once you have installed your extension locally, navigate to the **Manage** tab and select **Share**.
  ...
  ![Share button](./extensions-sdk/extensions/share/images/list-preview.png)

> [!NOTE]
>
> Previews of the extension description or screenshots, for example, are created using [extension labels](./extensions-sdk/extensions/share/labels.md).
