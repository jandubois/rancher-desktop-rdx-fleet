...
Whenever you are [ready to publish](./extensions-sdk/extensions/publish/DISTRIBUTION.md) your extension in the Marketplace, you can [self-publish your extension](https://github.com/docker/extensions-submissions/issues/new?assignees=&labels=&template=1_automatic_review.yaml&title=%5BSubmission%5D%3A+)
...
Before you submit your extension, it must pass the [validation](./extensions-sdk/extensions/publish/validate.md) checks.
...
- Review the [design guidelines](./extensions-sdk/extensions/design/design-guidelines.md)
- Ensure the [UI styling](./extensions-sdk/extensions/design.md) is in line with Docker Desktop guidelines
