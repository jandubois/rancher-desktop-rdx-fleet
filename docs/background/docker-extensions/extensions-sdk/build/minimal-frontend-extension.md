...
> Tip
>
> If you want to start a codebase for your new extension, our [Quickstart guide](./extensions-sdk/build/quickstart.md) and `docker extension init <my-extension>` provides a better base for your extension.
...
3. The source folder that contains all your HTML, CSS and JS files. There can also be other static assets such as logos
   and icons. For more information and guidelines on building the UI, see the [Design and UI styling section](./extensions-sdk/build/design/design-guidelines.md).

## Create a Dockerfile

At a minimum, your Dockerfile needs:

- [Labels](./extensions-sdk/build/extensions/labels.md) which provide extra information about the extension, icon and screenshots.
...
For more information on the `metadata.json`, see [Metadata](./extensions-sdk/build/architecture/metadata.md).
...
![Minimal frontend extension](./extensions-sdk/build/minimal-frontend-extension/images/ui-minimal-extension.png)

## What's next?

- Build a more [advanced frontend](./extensions-sdk/build/minimal-frontend-extension/frontend-extension-tutorial.md) extension.
