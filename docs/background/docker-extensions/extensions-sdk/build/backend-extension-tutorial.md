...
> Tip
>
> Check the [Quickstart guide](./extensions-sdk/build/quickstart.md) and `docker extension init <my-extension>`. They provide a better base for your extension as it's more up-to-date and related to your install of Docker Desktop.

## Why add a backend?

Thanks to the Docker Extensions SDK, most of the time you should be able to do what you need from the Docker CLI
directly from [the frontend](./extensions-sdk/build/backend-extension-tutorial/frontend-extension-tutorial.md).
...
For more information about extension backends, see [Architecture](./extensions-sdk/build/architecture.md).
...
For more information on the `vm` section of the `metadata.json`, see [Metadata](./extensions-sdk/build/architecture/metadata.md).
...
Using the [advanced frontend extension example](./extensions-sdk/build/backend-extension-tutorial/frontend-extension-tutorial.md), we can invoke our extension backend.
...
> See [Show extension containers](./extensions-sdk/build/dev/test-debug.md) for more information.
...
- Learn how to [share and publish your extension](./extensions-sdk/build/extensions.md).
