...
[Quickstart](./extensions-sdk/build/quickstart.md). This creates a new directory `my-extension` that contains a fully functional extension.
...
For more information on the `ui` section of the `metadata.json`, see [Metadata](./extensions-sdk/build/architecture/metadata.md).
...
![Auto completion in an IDE](./extensions-sdk/build/frontend-extension-tutorial/images/types-autocomplete.png)
...
![Screenshot of the container list.](./extensions-sdk/build/frontend-extension-tutorial/images/react-extension.png)
...
> [!TIP]
>
> You can turn on [hot reloading](./extensions-sdk/build/dev/test-debug.md) to avoid the need to
> rebuild the extension every time you make a change.

## What's next?

- Add a [backend](./extensions-sdk/build/frontend-extension-tutorial/backend-extension-tutorial.md) to your extension.
- Learn how to [test and debug](./extensions-sdk/build/dev/test-debug.md) your extension.
- Learn how to [setup CI for your extension](./extensions-sdk/build/dev/continuous-integration.md).
- Learn more about extensions [architecture](./extensions-sdk/build/architecture.md).
- For more information and guidelines on building the UI, see the [Design and UI styling section](./extensions-sdk/build/design/design-guidelines.md).
- If you want to set up user authentication for the extension, see [Authentication](./extensions-sdk/build/guides/oauth2-flow.md).
