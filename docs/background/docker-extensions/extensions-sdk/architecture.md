...
![Overview of the three components of an extension](./extensions-sdk/architecture/images/extensions-architecture.png)
...
[metadata](./extensions-sdk/architecture/metadata.md) section for more details.
...
`ui` section in the `metadata.json`. See the [ui metadata section](./extensions-sdk/architecture/metadata.md) for more details.
...
attaches it to the Compose project. See the [ui metadata section](./extensions-sdk/architecture/metadata.md) for more details.
...
> See [How to use the Docker socket](./extensions-sdk/guides/use-docker-socket-from-backend.md) from the backend.

To communicate with the backend, the Extension SDK provides [functions](./extensions-sdk/dev/api/backend.md) to make `GET`,
...
![Backend and frontend communication](./extensions-sdk/architecture/images/extensions-arch-2.png)
...
that are installed on the host when the extension is installed. The frontend can invoke them with [the extension SDK](./extensions-sdk/dev/api/backend.md).
...
the `metadata.json`. See the [ui metadata section](./extensions-sdk/architecture/metadata.md) for more details.

![Executable and frontend communication](./extensions-sdk/architecture/images/extensions-arch-3.png)
...
See the [host metadata section](./extensions-sdk/architecture/metadata.md) for more details.

Learn how to [invoke host binaries](./extensions-sdk/guides/invoke-host-binaries.md).



- [Extension metadata](./extensions-sdk/architecture/metadata.md)

- [Extension security](./extensions-sdk/architecture/security.md)
