...
- Learn more about extensions [architecture](./extensions-sdk/dev/architecture.md).
- Explore our [design principles](./extensions-sdk/dev/design/design-principles.md).
- Take a look at our [UI styling guidelines](./extensions-sdk/dev/design.md).
- Learn how to [setup CI for your extension](./extensions-sdk/dev/test-debug/continuous-integration.md).
