...
From your extension, you can also [navigate](./extensions-sdk/dev/api/dashboard/dashboard-routes-navigation.md) to other parts of the Docker Desktop Dashboard.
