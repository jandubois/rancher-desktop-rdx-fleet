...
The `ddClient.extension.vm` object can be used to communicate with the backend defined in the [vm section](./extensions-sdk/dev/architecture/metadata.md) of the extension metadata.
...
defined in the [vm section](./extensions-sdk/dev/architecture/metadata.md) of the
...
You can run binaries defined in the [host section](./extensions-sdk/dev/architecture/metadata.md)
