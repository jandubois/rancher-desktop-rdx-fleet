...
Read our [MUI best practices](./extensions-sdk/design/mui-best-practices.md) guide to learn future-proof ways to use MUI with Docker Desktop.
...
See our [MUI best practices](./extensions-sdk/design/mui-best-practices.md) article.
...
- Take a look at our [MUI best practices](./extensions-sdk/design/mui-best-practices.md).
- Learn how to [publish your extension](./extensions-sdk/extensions.md).



- [Design guidelines for Docker extensions](./extensions-sdk/design/design-guidelines.md)

- [Docker design principles](./extensions-sdk/design/design-principles.md)

- [MUI best practices](./extensions-sdk/design/mui-best-practices.md)
